<!-- 
developed by Alfreda and Adiza
Started on Wednesday, 1st July,2020
...
<div class="form-group">
  ...
  <div class="col-md-6">
  <input id="email" name="email" placeholder="Enter your Student ID" class="form-control input-md" type="text">
...
<div class="form-group">
  <label class="col-md-12 control-label" for="name"></label>  
  <div class="col-md-12">
  <input id="college" name="college" placeholder="Enter your college name" class="form-control input-md" type="hidden" value="University of Cape Coast">
      ...
      <div class="modal-body">
        <p>
            <div class="row">
              ...
              <div class="col-md-5">
                      <a href="#" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Adiza &</a>
